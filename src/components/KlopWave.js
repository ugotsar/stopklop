...
// Klop qui fait coucou (écran de connexion). Vectoriel : net à toutes les tailles.
export default function KlopWave({ width = 170 }) {
  return (
    <Svg width={width} height={(width * 120) / 130} viewBox="0 0 130 120">
      <Defs>
        <LinearGradient id="kwBody" x1="0" y1="0" x2="0" y2="1">
          <Stop offset="0" stopColor="#BCD0B7" />
          <Stop offset="0.6" stopColor="#9EB699" />
          <Stop offset="1" stopColor="#86A082" />
        </LinearGradient>
        <LinearGradient id="kwFeet" x1="0" y1="0" x2="0" y2="1">
      ...
      {/* Bras levé */}
      <Path d="M100 58 Q116 50 119 30" stroke="#A3BB9E" strokeWidth={10} strokeLinecap="round" fill="none" />
      <Circle cx={119.5} cy={27} r={7} fill="#AFC5AA" />

      <G transform="translate(15 0)">
        <Ellipse cx={50} cy={114} rx={36} ry={4.5} fill="#173D26" opacity={0.16} />
        <Rect x={27} y={94} width={17} height={18} rx={8} fill="url(#kwFeet)" />
        <Rect x={56} y={94} width={17} height={18} rx={8} fill="url(#kwFeet)" />
        <Rect x={10} y={10} width={80} height={90} rx={30} fill="url(#kwBody)" />
