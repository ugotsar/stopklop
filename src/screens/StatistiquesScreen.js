...
const styles = StyleSheet.create({
  ...
  progressTitleRow: { flexDirection: 'row', alignItems: 'center', gap: 8, flex: 1, marginRight: spacing.sm },
  progressTitleIcon: { width: 42, height: 42 },
  progressAmounts: { fontSize: 17, color: colors.primaryDeep, fontWeight: '800' },
  ...
  progressFlag:  { width: 34, height: 34 },
  progressFooter: { flexDirection: 'row', justifyContent: 'space-between', marginTop: spacing.sm },
  progressPct:   { fontSize: 14, fontWeight: '800', color: colors.primaryDeep },
